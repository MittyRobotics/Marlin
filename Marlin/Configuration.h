...
#define STRING_CONFIG_H_AUTHOR "(Vedansh Goenka, Ender 3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Vedansh's Ender-3 Pro"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.4, 80.3, 400.8, 98.7 }
